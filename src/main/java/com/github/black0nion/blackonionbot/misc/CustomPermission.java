...
public enum CustomPermission {
   ...
   * </pre>
   * <p>
   * Explanation: SET_STATUS is <i>INCLUDED in</i> DEVELOPER. DEVELOPERs also have the permission
   * SET_STATUS, and because DEVELOPER has the permission ADMIN admins can also use it
   *
  ...
  public static boolean hasRights(final CustomPermission requiredPermission,
