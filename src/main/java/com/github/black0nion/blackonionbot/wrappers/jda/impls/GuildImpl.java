...
public abstract class GuildImpl extends BlackWrapper implements Guild {
  ...
  @CheckReturnValue
  @Nonnull
  public RestAction<net.dv8tion.jda.api.interactions.commands.Command> retrieveCommandById(
      @NotNull String id) {
  ...
  @CheckReturnValue
  @Nonnull
  public RestAction<net.dv8tion.jda.api.interactions.commands.Command> upsertCommand(
  ...
  @CheckReturnValue
  @Nonnull
  public AuditableRestAction<Void> timeoutFor(@NotNull Member member, long amount,
  ...
  @CheckReturnValue
  @Nonnull
  public AuditableRestAction<Void> timeoutForById(long userId, long amount,
      @NotNull TimeUnit unit) {
  ...
  @CheckReturnValue
  @Nonnull
  public AuditableRestAction<Void> timeoutForById(@NotNull String userId, long amount,
      @NotNull TimeUnit unit) {
    return this.guild.timeoutForById(userId, amount, unit);
  }
  ...
  @CheckReturnValue
  @Nonnull
  public AuditableRestAction<Void> timeoutForById(@NotNull String userId,
  ...
  @CheckReturnValue
  @Nonnull
  public AuditableRestAction<Void> timeoutUntilById(long userId,
      @NotNull TemporalAccessor temporal) {
  ...
  @CheckReturnValue
  @Nonnull
  public AuditableRestAction<Void> timeoutUntilById(@NotNull String userId,
      @NotNull TemporalAccessor temporal) {
    return this.guild.timeoutUntilById(userId, temporal);
  }
