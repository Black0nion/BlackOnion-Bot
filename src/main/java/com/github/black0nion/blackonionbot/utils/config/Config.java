...
public class Config {
	...
	public static final @Nonnull String prefix = get("prefix", String.class, defaultValue("*"),
			matchesRegex("\\w{1,10}"));
	public static Activity.ActivityType activity_type = get("activity_type", Activity.ActivityType.class,
			defaultValue(Activity.ActivityType.PLAYING));
	public static String activity_name = get("activity_name", String.class, defaultValue(prefix));
	public static OnlineStatus online_status = get("online_status", OnlineStatus.class,
	...
	public static final String discordapp_client_secret = get("discordapp_client_secret", String.class,
			matchesRegex(Pattern.compile("^[a-z\\d=_\\-]{32}$", Pattern.CASE_INSENSITIVE)));
	public static final String discordapp_client_id = get("discordapp_client_id", String.class,
			matchesRegex("\\d{17,19}"));
	public static final String discordapp_redirect_url = get("discordapp_redirect_url", String.class,
			matchesRegex("https?://.+"));
	public static final String mongo_connection_string = get("mongo_connection_string", String.class, Flags.NonNull,
			matchesRegex(
	...
	public static final String openweatherapikey = get("openweathermap_api_key", String.class,
			matchesRegex("[a-z\\d]{32}"));
	@Nonnull
	...
	public static final int prometheus_port = get("prometheus_port", Integer.class, defaultValue(9090),
			range(0, 65535));
