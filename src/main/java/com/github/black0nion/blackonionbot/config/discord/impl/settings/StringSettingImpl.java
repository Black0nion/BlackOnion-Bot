...
public class StringSettingImpl extends AbstractSetting<String> implements StringSetting {
	...
	@SafeVarargs
	public StringSettingImpl(SettingsSaver settingsSaver, String name, String defaultValue, @Nullable Validator<String>... validators) {
		super(settingsSaver, name, defaultValue, String.class, false, validators);
	}

	@SafeVarargs
	public StringSettingImpl(SettingsSaver settingsSaver, String name, String defaultValue, boolean nullable, @Nullable Validator<String>... validators) {
