...
import static com.github.black0nion.blackonionbot.config.common.VariableLoader.loadVariables;
...
public class ConfigFileLoader {
	...
	public static void loadConfig() throws IOException {
		...
		if (ENV_FILE.exists()) {
			...
			loadVariables(Files.readAllLines(ENV_FILE.toPath()), count, ConfigFileLoader::set);
