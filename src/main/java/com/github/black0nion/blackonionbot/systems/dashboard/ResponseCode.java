...
public enum ResponseCode {
	...
	SUCCESS(true), FAIL("epic fail bru bru"), NO_ACTION(
			"No action specified."), WRONG_ARGUMENTS, UNAUTHORIZED, JSON_ERROR("Invalid JSON Syntax."), NO_GUILD(
					"No guild specified."), INVALID_TYPE("This type doesn't exist."), WRONG_SETTING(
