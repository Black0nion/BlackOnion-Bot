...
public class AntiSwearSystem {
  ...
  public static boolean check(final BlackGuild guild, final BlackMember author,
      final Message message, final TextChannel channel) {
    ...
    try {
      ...
      HttpResponse<String> response = Bot.getInstance().getHttpClient()
