...
public class Stats implements IGetRoute {
  ...
  public Object handle(Context ctx, JSONObject body, Map<String, String> headers,
    ...
    return new JSONObject()
        ...
        .put("cpu",
            new JSONObject().put("cpu_name", CPU_NAME)
                .put("cpu_cores", OSBEAN.getAvailableProcessors()).put("cpu_speed", CPU_MHZ))
        .put("guild_count", StatisticsManager.getGuildCount())
        .put("user_count", StatisticsManager.getUserCount()).put("prefix", Config.prefix)
        .put("os", OS_NAME)
