...
public class BlackSession {
	 ...
	 * websocket connection isn't logged in, use
	 * {@link OAuthUtils#loginWithDiscord(String)}
	 * <p>
	 * Auth flow:
	 * <ul>
	 * <li>client gets a session id using
	 * {@link OAuthUtils#loginWithDiscord(String)}</li>
	...
	public static String generateSessionId() {
		final String generatedId = ThreadLocalRandom.current().ints(LEFT_LIMIT_3, RIGHT_LIMIT_2 + 1)
				.filter(i -> ((i <= RIGHT_LIMIT_1 && i >= LEFT_LIMIT_1) || (i <= RIGHT_LIMIT_2 && i >= LEFT_LIMIT_2)
