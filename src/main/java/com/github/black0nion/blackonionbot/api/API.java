...
public class API {
	...
	public static void init() {
		...
		final Set<Class<? extends IWebSocketEndpoint>> websocketsClasses = reflections
				.getSubTypesOf(IWebSocketEndpoint.class);
		...
		ExceptionHandler<Exception> exceptionHandler = (e, ctx) -> {
			// dummy exceptions are just to instantly return from a handler, we don't care
			// about them
			...
			@Nullable
			final HttpResponseException http = e instanceof HttpResponseException eAsHttp ? eAsHttp : null;
