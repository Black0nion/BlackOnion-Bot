...
public class ToggleCommand extends Command {
	...
	public ToggleCommand() {
		this.setCommand("toggle").setSyntax("<command> <enabled / true / on | disabled / false / off>").setRequiredPermissions(Permission.ADMINISTRATOR).setRequiredArgumentCount(2).setDashboardCommand(false).notToggleable();
	}
