...
public class AutoRolesCommand extends TextCommand {
  ...
  public AutoRolesCommand() {
    this.setCommand("autoroles", "autorole")
        .setSyntax("<create | remove / delete> <@role | roleid>").setRequiredArgumentCount(2)
  ...
  public void execute(final String[] args, final CommandEvent cmde, final MessageReceivedEvent e,
    ...
    if (args[1].equalsIgnoreCase("create")) {
      ...
      cmde.success("autorolecreated", "autorolecreatedinfo",
      ...
      cmde.success("autorolesdeleted", "autoroledeletedinfo",
          new Placeholder("role", role.getAsMention()));
    } else
      cmde.sendPleaseUse();
  }
