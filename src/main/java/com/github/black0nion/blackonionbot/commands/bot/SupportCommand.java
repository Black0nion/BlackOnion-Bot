...
public class SupportCommand extends TextCommand {
	...
	@Override
	public void execute(final String[] args, final CommandEvent cmde, final MessageReceivedEvent event,
			final Message message, final BlackMember member, final BlackUser author, final BlackGuild guild,
			final TextChannel channel) {
		cmde.reply(cmde.success().addField("Get help", "[Discord Server](https://discord.gg/ZzGKy9RCBY)", false)
