...
public class PollCommand extends SlashCommand {
	...
	@Override
	public void execute(SlashCommandEvent cmde, SlashCommandInteractionEvent e, BlackMember member, BlackUser author, BlackGuild guild, TextChannel pollChannel, UserSettings userSettings, GuildSettings guildSettings) throws Exception {
