...
public class SlashCommandEvent {
	...
	public SlashCommandEvent(final SlashCommandInteractionEvent e, final BlackGuild guild, final BlackMember member,
			final BlackUser user) {
		this(null, e, guild, member, user);
	}

	public SlashCommandEvent(final SlashCommand cmd, final SlashCommandInteractionEvent e, final BlackGuild guild,
	...
	public void exception(@Nullable Throwable t) {
		...
		this.send("errorwithmessage", new Placeholder("msg",
				t != null
						? (t instanceof DummyException ? "" : t.getClass().getSimpleName() + ": ") + t.getMessage()
						: "null"));
	}
