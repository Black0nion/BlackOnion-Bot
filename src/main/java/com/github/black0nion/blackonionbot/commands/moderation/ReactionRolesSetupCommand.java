...
public class ReactionRolesSetupCommand extends TextCommand {
	...
	@Override
	public void execute(String[] args, final CommandEvent cmde, final MessageReceivedEvent e, final Message message, final BlackMember member, final BlackUser author, final BlackGuild guild, final TextChannel channel) {
