...
public class StatsJob implements Runnable {
  @Override
  public void run() {
    StatisticsManager.RAM_LOAD.labels(String.valueOf(StatisticsManager.getProcessMaxRamLoad()))
        .set(StatisticsManager.getProcessRamLoad());
    ...
    StatisticsManager.UPTIME
        .set((System.currentTimeMillis() - StatisticsManager.STARTUP_TIME) / 1000F);
