...
/**
 * Taken from <a href=
 * "https://github.com/tipsy/javalin-prometheus-example/blob/667293485c83e20cb674f67fac83a8578b839cb5/src/main/java/StatisticsHandlerCollector.java">tipsy/javalin-prometheus-example</a>
 * 
 * @author tipsy
 */
public class JettyCollector extends Collector {

  private final StatisticsHandler statisticsHandler;
  private static final List<String> EMPTY_LIST = new ArrayList<>();

  private JettyCollector(StatisticsHandler statisticsHandler) {
    this.statisticsHandler = statisticsHandler;
  }

  public static void initialize(StatisticsHandler statisticsHandler) {
    new JettyCollector(statisticsHandler).register();
  }
  ...
  private static MetricFamilySamples buildGauge(String name, String help, double value) {
    return new MetricFamilySamples(name, Type.GAUGE, help, Collections
  ...
  private static MetricFamilySamples buildCounter(String name, String help, double value) {
    return new MetricFamilySamples(name, Type.COUNTER, help, Collections
        .singletonList(new MetricFamilySamples.Sample(name, EMPTY_LIST, EMPTY_LIST, value)));
  }
