...
public class PlayerManager {
	...
	spotifyApi = new Api.Builder().clientId(Bot.getCredentialsManager().getString("spotify_client_id")).clientSecret(Bot.getCredentialsManager().getString("spotify_client_secret")).build();
