...
public class HelpCommand extends Command {
	...
	CommandBase.waiter.waitForEvent(ButtonClickEvent.class, event -> msg.getTextChannel().getIdLong() == event.getChannel().getIdLong() && msg == event.getMessage() && !event.getUser().isBot() && event.getUser().getIdLong() == author.getIdLong(), event -> {
