...
public class HangmanCommand extends SlashCommand {
	...
	this.setData(new CommandData("hangman", "Play a game of Hangman"));
	...
	cmde.reply(cmde.success().setTitle("hangman"), hook -> {
    ...
    private static void rerun(final Message msg, final SlashCommandExecutedEvent cmde, final String solution, final List<Character> alreadyGuessed) {
