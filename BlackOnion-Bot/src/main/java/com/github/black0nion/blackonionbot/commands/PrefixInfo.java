...
public class PrefixInfo extends ListenerAdapter {
	...
	public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
		...
		if (event.getAuthor().isBot() || message.getMentionedBlackUsers().size() == 0) return;
